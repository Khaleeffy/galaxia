...
function Viewer3D({planet,allPlanets,onClose,isPlayer,owner,state,onStateChange,onManage,userId,natalState,onColonize,alreadyColonized}){
  ...
  return(<div style={outerSt}>
    ...
    {showAttackModal&&natalState&&<AttackPrepModal planet={planet} natalState={natalState} attackComp={attackComp} setAttackComp={setAttackComp} onClose={function(){setShowAttackModal(false);}} onLaunch={function(){alert("Combat à venir étape 3.2 ! Composition: chasseurs="+attackComp.chasseur+", croiseurs="+attackComp.croiseur+", bombardiers="+attackComp.bombardier+", cuirasses="+attackComp.cuirasse);setShowAttackModal(false);}}/>}
