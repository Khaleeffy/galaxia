      ...
      {showPanel&&(
        <div style={{background:"rgba(4,10,24,.98)",border:"1px solid #1a3a60",borderRadius:14,padding:"14px 16px",width:220,boxShadow:"0 0 30px rgba(0,10,50,.9)"}}>
          ...
          <div style={{marginTop:14,paddingTop:12,borderTop:"1px dashed rgba(80,80,160,0.3)"}}>
            <button onClick={function(){
              if(!confirm("Cette action repare ta save (continents corrompus, flottes/anomalies cassees). Tes ressources et batiments sont preserves. Continuer ?"))return;
              try{
                var keys=[];
                ...
                for(var ix=0;ix<keys.length;ix++){
                  ...
                  try{
                    ...
                    for(var sj=0;sj<sk.length;sj++){var v=s.ships[sk[sj]];if(typeof v!=="number"||isNaN(v)||!isFinite(v)||v<0)s.ships[sk[sj]]=0;}
