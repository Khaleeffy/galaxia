  ...
  useEffect(function(){
    ...
    if(hasPlacements){
      ...
      for(var pli=0;pli<placements.length;pli++){
        ...
        for(var mi=0;mi<numMeshes;mi++){
          ...
          attackerShips.push({mesh:pship,type:pType,moving:false,destX:0,destZ:0,hp:pStats.hp*rep,maxHp:pStats.hp*rep,dps:pStats.dps*rep,range:pStats.range,fireCooldown:0,target:null,alive:true,side:"attacker",repCount:rep});
        }
      ...
      for(var atk=0;atk<attackerTypes.length;atk++){
        ...
        for(var qi=0;qi<qty;qi++){
          ...
          attackerShips.push({mesh:ship,type:t,moving:false,destX:0,destZ:0,hp:stats.hp,maxHp:stats.hp,dps:stats.dps,range:stats.range,fireCooldown:0,target:null,alive:true,side:"attacker"});
          idx++;
        }
      }
    }
    ...
    for(var dfk=0;dfk<dnPresent;dfk++){
      ...
      for(var dmi=0;dmi<dNumMeshes;dmi++){
        ...
        defenderShips.push({mesh:dship,type:dft,hp:dStats.hp*dRep,maxHp:dStats.hp*dRep,dps:dStats.dps*dRep,range:dStats.range,fireCooldown:0,target:null,alive:true,side:"defender",repCount:dRep});
      }
    ...
    for(var dt=0;dt<dnDefPresent;dt++){
      ...
      for(var dvq=0;dvq<dsNumMeshes;dvq++){
        ...
        defenses.push({mesh:defMesh,type:defType,hp:dfsStats.hp*dsRep,maxHp:dfsStats.hp*dsRep,dps:dfsStats.dps*dsRep,range:dfsStats.range,fireCooldown:0,target:null,alive:true,side:"defender",repCount:dsRep});
      }
