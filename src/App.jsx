...
function AudioControls(){
  ...
  const _rs4={position:"fixed",bottom:16,right:"calc(16px + env(safe-area-inset-right,0px))",zIndex:9000,display:"flex",flexDirection:"column",alignItems:"flex-end",gap:8,pointerEvents:"all"};
