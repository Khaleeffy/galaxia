...
function CombatScene({targetPlanet,attackerComp,defenderMilitary,testMode,onClose,onResolve}){
  ...
  useEffect(function(){
    ...
    // 45-degree angle: camera high but not too far, looking down at battlefield
    // Battlefield: enemy at z=-30, player at z=+50, planet far at z=-300
    cam.position.set(0,75,110);
    cam.lookAt(0,0,0);
    ...
    // Tap handlers (mouse + touch)
    function onMouseDown(e){onTap(e.clientX,e.clientY);}
    ...
    function animate(){
      ...
      cam.position.x=Math.sin(t*0.05)*8;
      cam.lookAt(0,0,0);
