  ...
  useEffect(function(){
    ...
    for(var atk=0;atk<attackerTypes.length;atk++){
      ...
      for(var qi=0;qi<qty;qi++){
        ...
        scene.add(ship);
        attackerShips.push({mesh:ship,type:t});
        idx++;
      }
    }
    ...
    function onTap(clientX,clientY){
      ...
      if(hits.length>0){
        // Find which ship this mesh belongs to
    ...
    function animate(){
      ...
      for(var si=0;si<attackerShips.length;si++){
        animateShip(attackerShips[si],si,0);
        // Sync halo position with ship + pulse if selected
        if(selectionHalos[si]){
          selectionHalos[si].position.x=attackerShips[si].mesh.position.x;
          selectionHalos[si].position.z=attackerShips[si].mesh.position.z;
