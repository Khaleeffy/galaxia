  ...
  return(<div style={_rs4}>
      {showPanel&&(
        <div style={{background:"rgba(4,10,24,.98)",border:"1px solid #1a3a60",borderRadius:14,padding:"14px 16px",width:220,boxShadow:"0 0 30px rgba(0,10,50,.9)"}}>
          ...
          {/* ── DEBUG: MODE CHEAT — gives a fully loaded starter pack ── */}
          <div style={{marginTop:10,padding:8,background:"rgba(60,40,10,0.3)",border:"1px solid rgba(200,160,60,0.4)",borderRadius:6}}>
